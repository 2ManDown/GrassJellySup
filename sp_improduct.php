                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="get">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">ลอตนำเข้าสินค้า</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">ประเภทบรรจุภัณฑ์</label>
                                                    <div class="col-sm-10">
                                                        <select name="account" class="form-control m-b">
                                                            <option value="" disabled selected>กรุณาเลือกประเภทบรรจุภัณฑ์</option>
                                                            <option>ถุง</option>
                                                            <option>ขวด</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">จำนวนนำเข้าสินค้า</label>
                                                    <div class="col-sm-10">
