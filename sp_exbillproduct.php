                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="get">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">ผู้รับสินค้า</label>
                                                    <div class="col-sm-10">
                                                        <select name="account" class="form-control m-b">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">ลอตส่งออกสินค้า</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">วันที่ส่งออก</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">จำนวนส่งออกสินค้า</label>
                                                    <div class="col-sm-10">
