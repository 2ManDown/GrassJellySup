                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="get">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">ลอตนำเข้าวัตถุดิบ</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">วันที่นำเข้าวัตถุดิบ</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">จำนวนนำเข้าวัตถุดิบ</label>
                                                    <div class="col-sm-10">
