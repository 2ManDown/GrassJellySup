        ...
        <section>
            ...
            <section class="hbox stretch">
                ...
                <section id="content">
                    <section class="hbox stretch">
                        <section>
                            <section class="vbox" style="margin: 0px; padding: 0px;">
                                <section class="scrollable padder" style="margin: 0px; padding: 0px;">
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="get" style="margin-top: 30px;">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group" style="margin: 30px 0px 50px 0px;">
                                                    <label class="col-sm-2 control-label">เลือกรูปสินค้า</label>
                                                    <div class="col-sm-10">
