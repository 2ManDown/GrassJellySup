                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="get">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">ลอตการผลิตสินค้า</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">สินค้าที่ผลิต</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">ชื่อสินค้า</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">ประเภทบรรจุภัณฑ์</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="input-id-1" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">วันที่ผลิต</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">จำนวนที่ผลิต</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">ราคารวม</label>
                                                    <div class="col-sm-10">
