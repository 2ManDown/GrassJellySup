                        ...
                        <nav class="nav-primary hidden-xs">
                            <ul class="nav nav-main" data-ride="collapse">
                                ...
                                <li>
                                    ...
                                    <ul class="nav dk">
                                        <li>
                                            <a href="Addemployee.php" class="auto">
                                                <i class="i i-dot"></i>
                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" method="get">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">เพศ</label>
                                                    <div class="col-sm-5">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">อายุ</label>
                                                    <div class="col-sm-5">
                                                ...
                                                <div class="line line-dashed b-b line-lg pull-in"></div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-id-1">อีเมล</label>
                                                    <div class="col-sm-5">
                                                        <input type="text" class="form-control" id="input-id-1">
                                                    </div>
                                                </div>
